...
from backend.api.v1.endpoints.chatbot import router as chatbot_router  # Add this

routers = APIRouter()
router_list = [admin_router, auth_router, billing_router, predicting_router, chatbot_router]  # Add chatbot_router
