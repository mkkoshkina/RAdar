...
def info_layout(user_session=None, lang: str = 'en'):
    ...
    return html.Div([
        ...
        html.Div([
            html.Div([
                ...
                html.Strong(t("important_notice", lang) + " "),
                t("important_text", lang)
            ], style={
                'padding': '20px',
